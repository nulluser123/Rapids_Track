...
def run():
    with sync_playwright() as p:
        ...
        page.locator('summary', has_text='MENTAL TRAINER').click()

        # Wait a sec for transition
        page.wait_for_timeout(500)

        page.screenshot(path="verification/with_player.png")
        print("📸 Screenshot saved to verification/with_player.png")
        browser.close()
